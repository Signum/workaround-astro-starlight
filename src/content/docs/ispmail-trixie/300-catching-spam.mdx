...
<details class="collapsible">
  <summary>Click here if you rather want to keep spam and sort away</summary>
...
<Aside type="tip" title="No headers?">
  ...
  use _swaks_ locally then you will not get anything.
</Aside>
...
support for [Sieve](<https://en.wikipedia.org/wiki/Sieve_(mail_filtering_language)>) filters which are scripts that run
